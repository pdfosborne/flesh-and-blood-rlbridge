...
def _run_training(args: argparse.Namespace) -> None:
    script_map = {
        "sage-precons": REPO_ROOT / "scripts" / "train_sage_precons.py",
        "silver-age": REPO_ROOT / "scripts" / "train_silver_age_decks.py",
        "classic-constructed": REPO_ROOT / "scripts" / "train_classic_constructed_decks.py",
    }
