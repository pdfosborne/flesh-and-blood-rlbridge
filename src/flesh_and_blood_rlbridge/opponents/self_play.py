...
class SelfPlayOpponent:
    """Mirror-style fallback policy for opponent slots.

    Uses random legal choices, intended for experiments where the same policy
    family should drive both sides but explicit self-play mode is disabled.
    """
